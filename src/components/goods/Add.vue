  ...
  <div>
    ...
    <el-card>
        ...
        <el-form ref="addFormRef" :model="addForm" :rules="addFormRules" label-width="100px" label-position="top">
          <el-tabs v-model="activeIndex" :tab-position="'left'" :before-leave="beforeTabLeave" @tab-click="clickTab">
    ...
    <el-dialog
      ...
      width="50%">
      <img :src="preview" alt="" class="imgView">
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleRemove(file){
      ...
      const index = this.addForm.pics.findIndex(function(a){
        return a.pic === filepath
      } )
    ...
    add(){
      this.$refs.addFormRef.validate(async valid=>{
        ...
        this.manyTableData.forEach(item => {
          ...
          console.log(typeof this.manyTableData );
        // 处理静态参数
